...
export const ADAPTED_ACTIVITY_OUTPUT_CONTRACT = {
  studentSheet: {
    ...
    questions:
      "array de objetos { command, support, answerSpace } para o estudante"
  },
  teacherGuide: {
  ...
  questions:
    "array de objetos { command, support, answerSpace } com atividades variadas, progressivas e espaco de resposta",
  visualElements:
